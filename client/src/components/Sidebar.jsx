// we require user from clerk to display the image,name of user in the sidebar 
import { Protect, useClerk, useUser } from '@clerk/clerk-react'
// this are all icons imported from lucid react for the sidebar functionalities
import { Eraser, FileText, Hash, House, Image, LogOut, Scissors, SquarePen, Users } from 'lucide-react';
import React from 'react'
import { NavLink } from 'react-router-dom';

// creating an array of object to ease the sidebar functionality
const navItems = [
...
// props - sidebar and setSidebar
const Sidebar = ({ sidebar, setSidebar }) => {
    // to display user name and image we require user information
    const {user} = useUser();
    // this below 2 are methods provided by clerk 
    const {signOut, openUserProfile} = useClerk()

  return (
    // depending on if the sidebar is open or not we use backticks and set the tailwind classes properties
