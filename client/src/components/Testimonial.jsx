...
// this testimonial page is taken from prebuiltUi.com

/*
Array(5).fill(0)
Creates an array with 5 elements, all initialized to 0
[0, 0, 0, 0, 0]

.map((_, index) => (...))
Loops through each of those 5 elements
_ means “I don’t care about the value” (which is 0)
index goes from 0 to 4

<img key={index} src={...} ... />
For each index (0 to 4), render an image of a star
key={index} is required by React for list rendering

src={index < testimonial.rating ? ... : ...}
This is a ternary operator:
index < testimonial.rating 
  ? assets.star_icon          // if true: use filled star
  : assets.star_dull_icon     // if false: use dull/empty star
